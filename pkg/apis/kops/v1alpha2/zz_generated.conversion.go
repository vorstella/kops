...
func RegisterConversions(scheme *runtime.Scheme) error {
	return scheme.AddGeneratedConversionFuncs(
		...
		Convert_v1alpha2_AuthRole_To_kops_AuthRole,
		Convert_kops_AuthRole_To_v1alpha2_AuthRole,
		...
		Convert_v1alpha2_SecurityGroup_To_kops_SecurityGroup,
		Convert_kops_SecurityGroup_To_v1alpha2_SecurityGroup,
		Convert_v1alpha2_SecurityGroups_To_kops_SecurityGroups,
		Convert_kops_SecurityGroups_To_v1alpha2_SecurityGroups,
...
func autoConvert_v1alpha2_AuthRole_To_kops_AuthRole(in *AuthRole, out *kops.AuthRole, s conversion.Scope) error {
	out.Master = in.Master
	out.Node = in.Node
	return nil
}

// Convert_v1alpha2_AuthRole_To_kops_AuthRole is an autogenerated conversion function.
func Convert_v1alpha2_AuthRole_To_kops_AuthRole(in *AuthRole, out *kops.AuthRole, s conversion.Scope) error {
	return autoConvert_v1alpha2_AuthRole_To_kops_AuthRole(in, out, s)
}

func autoConvert_kops_AuthRole_To_v1alpha2_AuthRole(in *kops.AuthRole, out *AuthRole, s conversion.Scope) error {
	out.Master = in.Master
	out.Node = in.Node
	return nil
}

// Convert_kops_AuthRole_To_v1alpha2_AuthRole is an autogenerated conversion function.
func Convert_kops_AuthRole_To_v1alpha2_AuthRole(in *kops.AuthRole, out *AuthRole, s conversion.Scope) error {
	return autoConvert_kops_AuthRole_To_v1alpha2_AuthRole(in, out, s)
}
...
// Convert_v1alpha2_ChannelAsset_To_kops_ChannelAsset is an autogenerated conversion function.
...
// Convert_kops_ChannelAsset_To_v1alpha2_ChannelAsset is an autogenerated conversion function.
...
func autoConvert_v1alpha2_ClusterSpec_To_kops_ClusterSpec(in *ClusterSpec, out *kops.ClusterSpec, s conversion.Scope) error {
	...
	if in.AuthRole != nil {
		...
		*out = new(kops.AuthRole)
		if err := Convert_v1alpha2_AuthRole_To_kops_AuthRole(*in, *out, s); err != nil {
			return err
		}
	} else {
		out.AuthRole = nil
	...
	if in.SecurityGroups != nil {
		...
		*out = new(kops.SecurityGroups)
		if err := Convert_v1alpha2_SecurityGroups_To_kops_SecurityGroups(*in, *out, s); err != nil {
			return err
		}
	} else {
...
func autoConvert_kops_ClusterSpec_To_v1alpha2_ClusterSpec(in *kops.ClusterSpec, out *ClusterSpec, s conversion.Scope) error {
	...
	if in.AuthRole != nil {
		in, out := &in.AuthRole, &out.AuthRole
		*out = new(AuthRole)
		if err := Convert_kops_AuthRole_To_v1alpha2_AuthRole(*in, *out, s); err != nil {
			return err
		}
	} else {
		out.AuthRole = nil
	...
	if in.SecurityGroups != nil {
		...
		*out = new(SecurityGroups)
		if err := Convert_kops_SecurityGroups_To_v1alpha2_SecurityGroups(*in, *out, s); err != nil {
			return err
		}
	} else {
		out.SecurityGroups = nil
...
// Convert_v1alpha2_CompressedFileAsset_To_kops_CompressedFileAsset is an autogenerated conversion function.
...
// Convert_kops_CompressedFileAsset_To_v1alpha2_CompressedFileAsset is an autogenerated conversion function.
...
// Convert_v1alpha2_ContainerAsset_To_kops_ContainerAsset is an autogenerated conversion function.
...
// Convert_kops_ContainerAsset_To_v1alpha2_ContainerAsset is an autogenerated conversion function.
...
// Convert_v1alpha2_ExecutableFileAsset_To_kops_ExecutableFileAsset is an autogenerated conversion function.
...
// Convert_kops_ExecutableFileAsset_To_v1alpha2_ExecutableFileAsset is an autogenerated conversion function.
...
// Convert_v1alpha2_HTTPProxySpec_To_kops_HTTPProxySpec is an autogenerated conversion function.
...
// Convert_kops_HTTPProxySpec_To_v1alpha2_HTTPProxySpec is an autogenerated conversion function.
...
// Convert_v1alpha2_HostAsset_To_kops_HostAsset is an autogenerated conversion function.
...
// Convert_kops_HostAsset_To_v1alpha2_HostAsset is an autogenerated conversion function.
...
// Convert_v1alpha2_Inventory_To_kops_Inventory is an autogenerated conversion function.
...
// Convert_kops_Inventory_To_v1alpha2_Inventory is an autogenerated conversion function.
...
// Convert_v1alpha2_InventorySpec_To_kops_InventorySpec is an autogenerated conversion function.
...
// Convert_kops_InventorySpec_To_v1alpha2_InventorySpec is an autogenerated conversion function.
...
func autoConvert_v1alpha2_SecurityGroup_To_kops_SecurityGroup(in *SecurityGroup, out *kops.SecurityGroup, s conversion.Scope) error {
	out.Name = in.Name
	out.ID = in.ID
	return nil
}

// Convert_v1alpha2_SecurityGroup_To_kops_SecurityGroup is an autogenerated conversion function.
func Convert_v1alpha2_SecurityGroup_To_kops_SecurityGroup(in *SecurityGroup, out *kops.SecurityGroup, s conversion.Scope) error {
	return autoConvert_v1alpha2_SecurityGroup_To_kops_SecurityGroup(in, out, s)
}

func autoConvert_kops_SecurityGroup_To_v1alpha2_SecurityGroup(in *kops.SecurityGroup, out *SecurityGroup, s conversion.Scope) error {
	out.Name = in.Name
	out.ID = in.ID
	return nil
}

// Convert_kops_SecurityGroup_To_v1alpha2_SecurityGroup is an autogenerated conversion function.
func Convert_kops_SecurityGroup_To_v1alpha2_SecurityGroup(in *kops.SecurityGroup, out *SecurityGroup, s conversion.Scope) error {
	return autoConvert_kops_SecurityGroup_To_v1alpha2_SecurityGroup(in, out, s)
}

func autoConvert_v1alpha2_SecurityGroups_To_kops_SecurityGroups(in *SecurityGroups, out *kops.SecurityGroups, s conversion.Scope) error {
	if in.Master != nil {
		in, out := &in.Master, &out.Master
		*out = new(kops.SecurityGroup)
		if err := Convert_v1alpha2_SecurityGroup_To_kops_SecurityGroup(*in, *out, s); err != nil {
			return err
		}
	} else {
		out.Master = nil
...
// Convert_v1alpha2_SecurityGroups_To_kops_SecurityGroups is an autogenerated conversion function.
func Convert_v1alpha2_SecurityGroups_To_kops_SecurityGroups(in *SecurityGroups, out *kops.SecurityGroups, s conversion.Scope) error {
	return autoConvert_v1alpha2_SecurityGroups_To_kops_SecurityGroups(in, out, s)
}

func autoConvert_kops_SecurityGroups_To_v1alpha2_SecurityGroups(in *kops.SecurityGroups, out *SecurityGroups, s conversion.Scope) error {
	if in.Master != nil {
		in, out := &in.Master, &out.Master
		*out = new(SecurityGroup)
		if err := Convert_kops_SecurityGroup_To_v1alpha2_SecurityGroup(*in, *out, s); err != nil {
			return err
		}
	} else {
		out.Master = nil
...
// Convert_kops_SecurityGroups_To_v1alpha2_SecurityGroups is an autogenerated conversion function.
func Convert_kops_SecurityGroups_To_v1alpha2_SecurityGroups(in *kops.SecurityGroups, out *SecurityGroups, s conversion.Scope) error {
	return autoConvert_kops_SecurityGroups_To_v1alpha2_SecurityGroups(in, out, s)
}
